...
CREATE TABLE NguoiDung (
    ...
    loaiNguoiDung TEXT CHECK (loaiNguoiDung IN ('SinhVien', 'GiangVien', 'GiaoVu', 'TruongBoMon', 'QuanTriVien', 'TruongKhoa')) NOT NULL
);
...
CREATE TABLE MonHoc (
    ...
    soTinChi INT,
    moTa TEXT,
    loaiMon TEXT CHECK (loaiMon IN ('BatBuoc', 'TuChon')),
...
CREATE TABLE LopHocPhan (
    ...
    siSoToiDa INT,
    siSoHienTai INT,
    trangThai TEXT CHECK (trangThai IN ('ChuaMo', 'DangHoc', 'DaKetThuc')) DEFAULT 'ChuaMo',
    ngayBatDau DATE,
    ngayKetThuc DATE,
    maGV VARCHAR(20),
...
CREATE TABLE SinhVien (
    ...
    trangThai TEXT CHECK (trangThai IN ('Dang hoc','Da tot nghiep','Nghi hoc','Bao luu')),
    maCN VARCHAR(20),
    maLop VARCHAR(20),
...
CREATE TABLE YeuCauMoLop (
    ...
    ngayGui DATE,
    tinhTrangTongQuat TEXT CHECK (tinhTrangTongQuat IN ('DaGui', 'DaDuyet', 'TuChoi', 'Huy')),
    trangThaiXuLy TEXT CHECK (trangThaiXuLy IN ('0_ChuaGui','1_GiaoVuNhan','2_TBMNhan','3_TruongKhoaNhan','4_ChoMoLop')) DEFAULT '0_ChuaGui',
    maSV VARCHAR(20),
    maLopHP VARCHAR(20), 
    maMH VARCHAR(20),
    maGV VARCHAR(20),
...
CREATE TABLE LichSuThayDoiYeuCau (
    ...
    maYeuCau VARCHAR(20),
    cotTrangThaiCu TEXT CHECK (cotTrangThaiCu IN ('0_ChuaGui', '1_GiaoVuNhan', '2_TBMNhan', '3_TruongKhoaNhan', '4_ChoMoLop')),
  cotTrangThaiMoi TEXT CHECK (cotTrangThaiMoi IN ('0_ChuaGui', '1_GiaoVuNhan', '2_TBMNhan', '3_TruongKhoaNhan', '4_ChoMoLop')),
    ngayThayDoi DATE,
...
ALTER TABLE ThoiKhoaBieu ALTER COLUMN maTKB TYPE VARCHAR(50);
...
CREATE TABLE BangTin (
    ...
    loaiNguoiDung TEXT CHECK (loaiNguoiDung IN ('SinhVien', 'GiangVien', 'TatCa')),
...
CREATE TABLE DangKyLichDay (
    ...
    maLopHP VARCHAR(20),
    ngayDangKy DATE,
    trangThai TEXT CHECK (trangThai IN ('ChoDuyet', 'ChapNhan', 'TuChoi')),
    FOREIGN KEY (maGV) REFERENCES GiangVien(maGV),
    FOREIGN KEY (maLopHP) REFERENCES LopHocPhan(maLopHP)
);
...
CREATE TABLE XuLyYeuCau (
    ...
    maYeuCau VARCHAR(20),
    vaiTroNguoiXuLy TEXT CHECK (vaiTroNguoiXuLy IN ('GiaoVu', 'TruongBoMon', 'TruongKhoa')),
    nguoiXuLy VARCHAR(20),
    ngayXuLy DATE,
    trangThai TEXT CHECK (trangThai IN ('ChuyenTiep', 'DongY', 'TuChoi')),
    ghiChu TEXT,
    FOREIGN KEY (maYeuCau) REFERENCES YeuCauMoLop(maYeuCau),
...
CREATE TABLE PhanLop (
    maSV VARCHAR(20),
    maLopHP VARCHAR(20),
    trangThai TEXT CHECK (trangThai IN ('DangHoc', 'DaKetThuc', 'TamNgung')) DEFAULT 'DangHoc',
...
CREATE TABLE MauThoiKhoaBieu (
    ...
    loaiBuoi TEXT CHECK (loaiBuoi IN ('LyThuyet', 'ThucHanh')) DEFAULT 'LyThuyet',
...
CREATE TABLE LichHoc (
    ...
    tietKT VARCHAR(5) NOT NULL,
    phongHoc VARCHAR(10) NOT NULL,
    loaiBuoi TEXT CHECK (loaiBuoi IN ('LyThuyet', 'ThucHanh')) NOT NULL,
...
BEGIN
    ...
    DECLARE v_loaiBuoi TEXT CHECK (v_loaiBuoi IN ('LyThuyet', 'ThucHanh'));
